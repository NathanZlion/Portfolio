...
export const IconBrandGoFiber = ({ className }: { className?: string }) => {
    ...
    return (
        <div className={cn("flex justify-center items-center", className)}>
            <svg viewBox="0 0 800 300" className="h-4" xmlns="http://www.w3.org/2000/svg">
                <g fill={fill}>
                ...
                <path d="m213.77 115.41h-134.51l-10.76 15.27 142.78-.08z" fill={fill} />
                <path d="m209.02 147.06h-174.07l-11.07 15.21 182.65-.13z" fill={fill} />
                <path d="m204.27 178.7h-74.37l-10 15.27 81.88-.06z" fill={fill} />
            </svg>
        </div>
    );
}
